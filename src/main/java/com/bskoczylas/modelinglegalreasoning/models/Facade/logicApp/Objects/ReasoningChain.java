...
import com.bskoczylas.modelinglegalreasoning.models.Facade.logicApp.PropBaseClean;
...
public class ReasoningChain {
    ...
    public Pair<Set<Rule>, Proposition> subjectiveReasoningChain(Agent agent, KnowledgeBase subjectiveKB,
        ...
        Deque<Pair<Proposition, Iterator<Rule>>> stack = new ArrayDeque<>();
        stack.push(new Pair<>(, rj.iterator()));
